...
export default function QuickSort(){
    ...
    const getBarColor = (idx) => {
        ...
        if (idx === pivot) return 'bg-amber-500 shadow-[0_0_15px_rgba(245,166,35,0.5)]';
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="bg-[#1a1611]/50 backdrop-blur-xl border border-[#332b21] rounded-3xl p-6 sm:p-8 shadow-2xl flex flex-wrap gap-6 items-center justify-between">
                    ...
                    <div className="flex flex-col gap-2 w-full sm:w-auto">
                        ...
                        <input type="range" min={100} max={2000} value={speed} onChange={(e)=>setSpeed(Number(e.target.value))} className="w-full sm:w-48 accent-yellow-500 h-2 bg-[#332b21] rounded-lg appearance-none cursor-pointer"/>
                    </div>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6 flex flex-col">
                        <div className={`flex-1 rounded-3xl p-6 sm:p-8 border shadow-xl transition-all duration-300 ${
                            complete ? "bg-emerald-950/20 border-emerald-500/30" : "bg-[#1a1611]/50 border-[#332b21] backdrop-blur-xl"
                        }`}>
                        ...
                        <div className="bg-[#1a1611]/50 backdrop-blur-xl border border-[#332b21] rounded-3xl p-6 shadow-xl">
                            ...
                            <div className="flex flex-wrap gap-6">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="w-5 h-5 bg-amber-500 rounded-lg shadow-[0_0_10px_rgba(245,166,35,0.5)]"></div>
                                    <span className="text-[#EAEAEA] font-medium">Pivot</span>
                                </div>
                                <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[#EAEAEA] font-medium">Sorted</span>
                                </div>
                            </div>
                        </div>
                    </div>
